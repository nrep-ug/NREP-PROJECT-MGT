import { COLLECTIONS } from '@/lib/appwriteAdmin';
/**
...
export const collectionsDefinition = [
  ...
  },
  {
    ...
    attrs: [
      ...
      { key: 'clientOrganizationIds', type: 'string', size: 64, array: true }, // for only client users
      { key: 'projectIds', type: 'string', size: 64, array: true }, // for only client users
      { key: 'organizationLabel', type: 'string', size: 64, array: true },
      { key: 'supervisorId', type: 'string', size: 64 },
      ...
      { key: 'isFinance', type: 'boolean', default: false },
      { key: 'isSupervisor', type: 'boolean', default: false },
    ],
    indexes: [
  ...
  {
    id: COLLECTIONS.PROJECT_COMPONENTS,
    name: 'Project Components',
    attrs: [
      { key: 'projectId', type: 'string', size: 64, required: true },
      { key: 'name', type: 'string', size: 190, required: true },
      { key: 'description', type: 'string', size: 2000 },
      { key: 'leaderId', type: 'string', size: 64 },
    ],
    indexes: [
  ...
  },
  {
    ...
    attrs: [
      ...
      { key: 'components', type: 'string', size: 64, array: true },
      { key: 'createdBy', type: 'string', size: 64 },
  ...
  {
    id: COLLECTIONS.TASK_ASSIGNMENTS,
  ...
  },
  {
    ...
    attrs: [
      ...
      // { key: 'approvalComments', type: 'string', size: 1000 },
      { key: 'supervisorApproval', type: 'boolean', default: false },
      { key: 'supervisorApproverId', type: 'string', size: 64 },
      { key: 'supervisorComments', type: 'string', size: 1000 },
      { key: 'supervisorApprovedAt', type: 'datetime' },
      { key: 'adminApproval', type: 'boolean', default: false },
      { key: 'adminApproverId', type: 'string', size: 64 },
      { key: 'adminComments', type: 'string', size: 1000 },
      { key: 'adminApprovedAt', type: 'datetime' },
      { key: 'rejectedBy', type: 'string', size: 64 },
      { key: 'rejectedAt', type: 'datetime' },
  ...
  {
    id: COLLECTIONS.TIMESHEET_ENTRIES,
  ...
  {
    id: COLLECTIONS.DOCUMENT_FOLDERS,
  ...
  {
    id: COLLECTIONS.DOCUMENT_VERSIONS,
  ...
  },
  {
    ...
    attrs: [
      ...
      { key: 'color', type: 'string', size: 32, default: 'secondary' },
      { key: 'permissions', type: 'string', size: 64, array: true },
      { key: 'priority', type: 'integer', default: 50 },
      { key: 'isDefault', type: 'boolean', default: false },
      { key: 'isStaffRole', type: 'boolean', default: true },
      { key: 'createdBy', type: 'string', size: 64 },
    ],
    indexes: [
      { key: 'idx_project', type: 'key', attrs: ['projectId'] },
      { key: 'idx_project_slug', type: 'unique', attrs: ['projectId', 'slug'] }
    ]
  }
];
