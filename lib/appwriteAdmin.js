...
const { COLLECTIONS } = require('./appwriteClient');
...
module.exports = {
  ...
  Role,
  DB_ID,
  BUCKET_DOCS: process.env.NEXT_PUBLIC_APPWRITE_BUCKET_DOCS || 'pms-project-docs',
  BUCKET_VERSIONS: process.env.NEXT_PUBLIC_APPWRITE_BUCKET_VERSIONS || 'pms-doc-versions',
  COLLECTIONS,
};
