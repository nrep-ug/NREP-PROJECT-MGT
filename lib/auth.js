...
export async function getUserSession() {
  try {
    ...
    // Step 4: Check if user is a supervisor (if anyone has them as supervisedBy)
    ...
    const isSupervisor = supervisedStaff.documents.length > 0;
    ...
    // Step 5: Get user's role from labels (not from team membership)
