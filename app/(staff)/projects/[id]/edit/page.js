...
export default function EditProjectPage() {
  ...
  // Populate form once project data is loaded
  useEffect(() => {
    if (project) {
      setFormData({
        name: project.name || '',
  ...
  // Authorization: only admins or project creator can edit
  const canEdit = user?.isAdmin || project.createdBy === user?.authUser?.$id;
  if (!canEdit) {
    return (
      <AppLayout user={user}>
        <Alert variant="danger">
          <i className="bi bi-shield-lock me-2"></i>
          <strong>Access Denied.</strong> Only administrators and the project creator can edit this project.
        </Alert>
        <Button
          variant="link"
          ...
          <Card.Body className="text-white p-4">
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h2 className="mb-1 fw-bold">Edit Project</h2>
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    style={{ padding: '0.75rem', borderRadius: '8px', opacity: 0.7 }}
                  />
